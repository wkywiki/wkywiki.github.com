...
h3(#tools). Tools
* "Rails-dev-box":https://github.com/rails/rails-dev-box - rails虚拟开发环境部署工具
...
* "EventMachine":http://rubyeventmachine.com/ - 一款快速、简单的事件处理库
...
** "Codecademy的Ruby教程":http://www.codecademy.com/tracks/ruby
** "Try Ruby":http://tryruby.org
* *(#references_rails)Rails*
** "Ruby on Rails Tutorial 中文版":http://railstutorial-china.org/
...
* "Rabel":https://github.com/daqing/rabel - 仿v2ex的开源社区应用
* "robbin_site":https://github.com/robbin/robbin_site - CSDN的CTO范凯的个人开源博客系统
